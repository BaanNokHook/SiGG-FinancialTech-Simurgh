...
namespace GM.CommonLibs.Helper
{
    ...
    public static class SOAPHelper
    {
        ...
        /// <param name="xmlPlayload">Playload</param>
        ...
        public static string SendSOAPRequest(string url, string action, string xmlPlayload, string soapAction = null, bool useSOAP12 = false)
        {
            try
            {
                ...
                soapEnvelopeXml.LoadXml(xmlPlayload);
